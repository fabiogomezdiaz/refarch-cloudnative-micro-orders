...
[![Build Status](https://travis-ci.org/fabiogomezdiaz/refarch-cloudnative-micro-orders.svg?branch=spring)](https://travis-ci.org/fabiogomezdiaz/refarch-cloudnative-micro-orders)
...
As the APIs in this microservice as OAuth protected, the HS256 shared secret used to sign the JWT generated by the [Authorization Server](https://github.com/fabiogomezdiaz/refarch-cloudnative-micro-auth) is needed to validate the access token provided by the caller.
...
Note that if the [Authorization Server](https://github.com/fabiogomezdiaz/refarch-cloudnative-micro-auth) is also deployed, it must use the *same* HS256 shared secret.
...
To see the Orders app working in a more complex microservices use case, checkout our Microservice Reference Architecture Application [here](https://github.com/fabiogomezdiaz/refarch-cloudnative-kubernetes/tree/master).
...
* https://github.com/fabiogomezdiaz/refarch-cloudnative-micro-orders/graphs/contributors
